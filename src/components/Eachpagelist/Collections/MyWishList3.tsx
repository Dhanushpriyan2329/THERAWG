      ...
      <div className="card__mainCard">
        <div className="card card_items bg-dark">
          ...
          <div className="card-body">
            ...
            <div>
              <Link to={"/Wishlist/:id" +game4.id} className="card-title">
                {`${game4.name} - ${game4.id}`}
              </Link>
            </div>
            <div>
