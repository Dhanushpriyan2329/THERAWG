...
import MyWishList11 from "./MyWishList11";
import ScaleLoader from "react-spinners/ScaleLoader";

const MyWishListResult11 = () => {
  const [games11, setGames] = useState([]);
...
export default MyWishListResult11;
