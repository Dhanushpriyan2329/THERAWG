      ...
      <div className="card__mainCard">
        <div className="card card_items bg-dark">
          ...
          <div className="card-body">
            ...
            <div>
              <Link to={"/Wishlist/:id" +game12.id} className="card-title">
                {`${game12.name} - ${game12.id}`}
              </Link>
            </div>
            <div>
            ...
            <div className="card__textdate">
              ...
              <div>
                <p>{`${game12.released}` || `29-11-2023`}</p>
              </div>
            </div>
            <div className="card__textdate">
              <p>Geners</p>
