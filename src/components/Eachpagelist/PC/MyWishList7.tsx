      ...
      <div className="card__mainCard">
        <div className="card card_items bg-dark">
          ...
          <div className="card-body">
            ...
            <div>
              <Link to={"/Wishlist/:id" +game8.id} className="card-title">
                {`${game8.name} - ${game8.id}`}
              </Link>
            </div>
            <div>
